...
static void greybus_dissect_functionality(tvbuff_t *tvb, packet_info *pinfo, proto_tree *greybus_tree, struct gb_operation_msg_hdr *header)
{
...
static void greybus_dissect_payload(tvbuff_t *tvb, packet_info *pinfo, proto_tree *greybus_tree, struct gb_operation_msg_hdr *header)
{
    ...
    case GB_I2C_TYPE_FUNCTIONALITY:
		greybus_dissect_functionality(tvb, pinfo, greybus_tree, header);
    	break;
